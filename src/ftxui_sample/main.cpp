...
// configuration step. It creates a namespace called `ferm`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", ferm::cmake::project_name, ferm::cmake::project_version) };
